...
DISK_SIZE="$(python -c "print $(disk_usage "$THEOS_ROOT/Base")+$(disk_usage Root)+100")"
...
if [ $use_genext2fs = 1 ]; then
    ...
    # if it's not enough.
    # not using "-i 128" since it hangs. TheOS handles whatever default this uses instead.
